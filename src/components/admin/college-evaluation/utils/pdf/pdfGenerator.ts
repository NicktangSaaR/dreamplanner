...
export const generateEvaluationPdf = (evaluation: StudentEvaluation, universityType: UniversityType): jsPDF => {
  ...
  // Add standard font for better global character support
  // This is needed for proper rendering of Chinese characters
  doc.addFont("helvetica", "Helvetica", "normal");
  doc.addFont("helvetica", "Helvetica", "bold");
  
  // Set default font to Helvetica which has better support for Asian characters
