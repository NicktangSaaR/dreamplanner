...
export const generateEvaluationPdf = (evaluation: StudentEvaluation, universityType: UniversityType): jsPDF => {
  ...
  // Add default fonts for better multilingual text support
  doc.setFont("helvetica");
  
  // Load a specific font for Chinese characters if needed
  try {
    // Using the built-in fonts which have better compatibility
    doc.setFont("helvetica");
  } catch (error) {
