...
// Base64 encoded logo for "DreamPlanner"
...
// Company slogan updated to "Weave Your Dreams"
const slogan = 'Weave Your Dreams';
...
export const addDocumentHeader = (doc: jsPDF, evaluation: StudentEvaluation, universityType: UniversityType) => {
  ...
  doc.text(`US Undergraduate Admission Evaluation - ${universityTypeDisplay}`, 105, 25, { align: 'center' });
